...
from retnet_mlm import SimpleRetention, MultiScaleRetention, RetNetMLM
...
# class TestRetNetMLM(unittest.TestCase):

    def test_retnet_mlm(self):
        """
        ...
        # retnet = RetNetMLM(vocab_size, hidden_size, heads, layers, sequence_length, dropout=dropout, double_v_dim=True)
